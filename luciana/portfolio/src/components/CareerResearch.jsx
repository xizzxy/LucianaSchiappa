        ...
        >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    A tax attorney is a lawyer who specializes in helping people and businesses understand and follow tax laws. Tax attorneys combine legal expertise with financial acumen to help individuals and organizations minimize tax liability while remaining compliant with the law.
                  </p>
                </div>
              </div>
            </div>
          ...
          <motion.div variants={itemVariants} className="mb-12">
            <div className="bg-navy-800/50 backdrop-blur-sm rounded-xl p-8 border border-gold-400/20 hover:border-gold-400/40 transition-all duration-300">
              ...
              <ul className="grid md:grid-cols-2 gap-4">
                {[
                  'Research and interpret tax laws and ensure compliance with regulations.',
                  'Advise and represent clients on tax strategies, financial decisions, IRS audits, disputes, and negotiations.'
          ...
          <motion.div variants={itemVariants} className="mb-12">
            <div className="bg-navy-800/50 backdrop-blur-sm rounded-xl p-8 border border-gold-400/20 hover:border-gold-400/40 transition-all duration-300">
              ...
              <ul className="space-y-2">
                {[
                  "Bachelor's degree in Finance and Political Science",
