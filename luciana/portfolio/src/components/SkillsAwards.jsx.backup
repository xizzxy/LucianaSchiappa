          ...
          <motion.div variants={itemVariants} className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-navy-800/50 backdrop-blur-sm rounded-xl p-8 border border-gold-400/20 hover:border-gold-400/40 transition-all duration-300">
                ...
                <div className="mt-6 bg-navy-700/50 rounded-lg overflow-hidden border border-gold-400/20 h-48">
                  <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-navy-700 to-navy-800">
                    <div className="text-center">
                      ...
                      <p className="text-gray-300 font-semibold mb-1">FBLA Nationals</p>
                      <p className="text-gray-400 text-sm px-4">National Qualifier & Competitor</p>
                      <p className="text-gray-500 text-xs mt-2">Image: /images/image 4.png</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="mt-6 bg-navy-700/50 rounded-lg overflow-hidden border border-gold-400/20 h-48">
                  <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-navy-700 to-navy-800">
                    <div className="text-center">
                      ...
                      <p className="text-gray-300 font-semibold mb-1">State Competition</p>
                      <p className="text-gray-400 text-sm px-4">3rd Place - Client Service</p>
                      <p className="text-gray-500 text-xs mt-2">Image: /images/image 5.png</p>
                    </div>
                  </div>
                </div>
              </div>
